...
Ví dụ: 'Chào thầy', 'Thầy khỏe không', 'Cảm ơn', 'Dạ', 'Chúc ngủ ngon'
...
**BUDDHISM**: TẤT CẢ câu hỏi còn lại - bao gồm Phật học và các chủ đề khác
Ví dụ: 'Duyên khởi là gì?', 'Kinh Kim Cang?', 'Thời tiết hôm nay?', 'AI là gì?'

CHỈ trả một từ: GREET, SENSITIVE, hoặc BUDDHISM
