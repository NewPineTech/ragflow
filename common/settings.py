...
def init_settings():
    ...
    PARSERS = llm_settings.get(
        "parsers", "naive:General,qa:Q&A,resume:Resume,jd:JD,manual:Manual,table:Table,paper:Paper,book:Book,laws:Laws,presentation:Presentation,picture:Picture,one:One,audio:Audio,email:Email,tag:Tag"
    )
